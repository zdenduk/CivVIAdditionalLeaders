...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Districts/Production/03_Texture/DIS_PRD_Base_G.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>223075304</m_ExportedTime>
	<m_ClassName text="Generic_Gloss"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="DIS_PRD_Base_G.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="DIS_PRD_Base_G"/>
	<m_Description text=""/>
	<m_Tags>
