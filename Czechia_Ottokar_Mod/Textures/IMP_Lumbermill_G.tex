...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Improvements/Lumber_Mill/03_Texture/IMP_Lumbermill_G.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2725857317</m_ExportedTime>
	<m_ClassName text="Generic_Gloss"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="IMP_Lumbermill_G.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="IMP_Lumbermill_G"/>
	<m_Description text=""/>
	<m_Tags>
