...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Shared/Generic_Textures/Burn_G.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3875443135</m_ExportedTime>
	<m_ClassName text="Generic_Gloss"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Burn_G.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Burn_G"/>
	<m_Description text="Gloss for burn material"/>
	<m_Tags>
