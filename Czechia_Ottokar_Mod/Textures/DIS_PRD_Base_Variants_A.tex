...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Districts/Production/03_Texture/DIS_PRD_Base_Variants_A.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4102533884</m_ExportedTime>
	<m_ClassName text="Generic_AO"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="DIS_PRD_Base_Variants_A.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="DIS_PRD_Base_Variants_A"/>
	<m_Description text=""/>
	<m_Tags>
