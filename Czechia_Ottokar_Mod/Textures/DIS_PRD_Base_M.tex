...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Districts/Production/03_Texture/DIS_PRD_Base_M.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>695336257</m_ExportedTime>
	<m_ClassName text="Generic_Metalness"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="DIS_PRD_Base_M.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="DIS_PRD_Base_M"/>
	<m_Description text=""/>
	<m_Tags>
