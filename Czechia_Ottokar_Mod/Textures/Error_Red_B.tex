...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/ErrorAssets/Error_Red_B.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1125118557</m_ExportedTime>
	<m_ClassName text="Generic_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Error_Red_B.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Error_Red_B"/>
	<m_Description text=""/>
	<m_Tags>
